...
VALUES (1, 'ROLE_USUARIO');
INSERT INTO roles (id_rol, nombre)
VALUES (2, 'ROLE_ADMIN');
INSERT INTO roles (id_rol, nombre)
VALUES (3, 'ROLE_INVITADO');
INSERT INTO usuarios (username, nombre, apellidos, fecha_nacimiento, fecha_registro, contrasena, enabled)
VALUES ('superadmin', 'SuperAdmin', 'SuperAdmin', '2000-01-01', CURDATE(), 'password', TRUE);
INSERT INTO usuario_rol (username, id_rol) VALUES ('superadmin', 2);
commit;
