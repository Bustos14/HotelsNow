...
public interface HoteleRepository extends JpaRepository<Hotele, Integer>{
	 ...
	 * @return -> Devuelve el hotel que conicide con el correoelectronico que le hemos pasado por parÃ¡metro
	 */
    ...
    /**
     * @param disponible -> pasamos por parÃ¡metro un estado, 0 para no disponible, 1 para disponible
